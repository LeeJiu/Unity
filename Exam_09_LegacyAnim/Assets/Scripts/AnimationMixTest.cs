...
public class AnimationMixTest : MonoBehaviour
{
    ...
    /// Mix 
    /// </summary>
    public Transform atkMixTransform;
    private bool bAddMix = false;
    ...
    private void Awake()
    {
        ...
        this.charAnim["ShotPose"].AddMixingTransform(this.atkMixTransform);
    }
    ...
    void Update()
    {
        ...
        {
            this.charAnim.CrossFade("ShotPose", 0.3f);
        }
    }
    ...
    void UpdateMoveAnim(Vector3 moveVec)
    {
        if (moveVec == Vector3.zero)
        {
            ...
            //움직이지 않을 때는 애니메이션을 섞지 않겠다.
            if(this.bAddMix && this.charAnim.IsPlaying("Atk1") == false)
            {
                this.charAnim["Atk1"].RemoveMixingTransform(this.atkMixTransform);
                this.bAddMix = false;
            }
        }
        else
        {
            if(this.bAddMix == false)
            {
                this.charAnim["Atk1"].AddMixingTransform(this.atkMixTransform);
                this.bAddMix = true;
            }
